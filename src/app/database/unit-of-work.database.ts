...
import {ILocalReportRepository, LocalReportRepository} from "./repositories/local-report.repository";
...
import {DelayRepository, IDelayRepository} from "./repositories/delay.repository";
import {GeneratorRepository, IGeneratorRepository} from "./repositories/generator.repository";
import {ILocationRepository, LocationRepository} from "./repositories/location.repository";
import {IMotorRepository, MotorRepository} from "./repositories/motor.repository";
import {IQTARepository, QTARepository} from "./repositories/qta.repository";
import {ITechnicianRepository, TechnicianRepository} from "./repositories/technician.repository";
import {ITypeRepository, TypeRepository} from "./repositories/type.repository";
import {IUnitRepository, UnitRepository} from "./repositories/unit.repository";
import {IUserRepository, UserRepository} from "./repositories/user.repository";
import {ISynchronizationRepository, SynchronizationRepository} from "./repositories/synchronization.repository";
...
export class UnitOfWorkDatabase implements IUnitOfWorkDatabase {
  ...
  public get answerRepository(): IAnswerRepository {
    return this._answerRepository ?? (this._answerRepository = new AnswerRepository(this._database));
  }

  public get categoryRepository(): ICategoryRepository {
    return this._categoryRepository ?? (this._categoryRepository = new CategoryRepository(this._database));
  }

  public get contactRepository(): IContactRepository {
    return this._contactRepository ?? (this._contactRepository = new ContactRepository(this._database));
  }

  public get customerRepository(): ICustomerRepository {
    return this._customerRepository ?? (this._customerRepository = new CustomerRepository(this._database));
  }

  public get countryRepository(): ICountryRepository {
    return this._countryRepository ?? (this._countryRepository = new CountryRepository(this._database));
  }

  public get delayRepository(): IDelayRepository {
    return this._delayRepository ?? (this._delayRepository = new DelayRepository(this._database));
  }

  public get generatorRepository(): IGeneratorRepository {
    return this._generatorRepository ?? (this._generatorRepository = new GeneratorRepository(this._database));
  }

  public get localReportRepository(): ILocalReportRepository {
    return this._localReportRepository ?? (this._localReportRepository = new LocalReportRepository(this._database));
  }

  public get locationRepository(): ILocationRepository {
    return this._locationRepository ?? (this._locationRepository = new LocationRepository(this._database));
  }

  public get motorRepository(): IMotorRepository {
    return this._motorRepository ?? (this._motorRepository = new MotorRepository(this._database));
  }

  public get QTARepository(): IQTARepository {
    return this._QTARepository ?? (this._QTARepository = new QTARepository(this._database));
  }

  public get technicianRepository(): ITechnicianRepository {
    return this._technicianRepository ?? (this._technicianRepository = new TechnicianRepository(this._database));
  }

  public get typeRepository(): ITypeRepository {
    return this._typeRepository ?? (this._typeRepository = new TypeRepository(this._database));
  }

  public get unitRepository(): IUnitRepository {
    return this._unitRepository ?? (this._unitRepository = new UnitRepository(this._database));
  }

  public get userRepository(): IUserRepository {
    return this._userRepository ?? (this._userRepository = new UserRepository(this._database));
  }

  public get synchronizationRepository(): ISynchronizationRepository {
    return this._synchronizationRepository ?? (this._synchronizationRepository = new SynchronizationRepository(this._database));
  }
